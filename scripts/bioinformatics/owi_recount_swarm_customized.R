...
## customized by Mike Allen (2023) to allow it to run as a script and not a program (to troubleshoot)
  ...
  fileswarm <- "data/merged.uni.c10.l75.L125.sht.srt.nochi.1line.swarm5.C_output" #Must be an output file from swarm 
  filetab <- "data/merged.uni.c10.l75.L125.sht.C.tab"
