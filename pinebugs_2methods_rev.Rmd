...
readsC = cs3 %>% group_by(sci) %>% summarize(count = sum(count))
readsZ = zs3 %>% group_by(sci) %>% summarize(count = sum(count))
...
ggsave("figures/rev_Fig1_accumcurves11.png", width = 12, height = 10, dpi = 400) # 4-panel
