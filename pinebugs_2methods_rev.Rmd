...
(
  plot.sp <-
    ...
    geom_point(
      ...
      #alpha = 0.85,
      color = "black",
      data = filter(sites.long1, primer == "COI")
    ) +
    coord_fixed(ratio = 1) +
    labs(
      y = "NMDS2",
...
(
  plot.gen <-
    ...
    geom_point(
      ...
      #alpha = 0.85,
      color = "black",
      data = filter(sites.long1.gen, primer == "COI")
    ) +
    coord_fixed(ratio = 1) +
    labs(
      y = "NMDS2",
...
(
  plot.fam <-
    ...
    geom_point(
      ...
      #alpha = 0.85,
      color = "black",
      data = filter(sites.long1.fam, primer == "COI")
    ) +
    coord_fixed(ratio = 1) +
    labs(
      y = "NMDS2",
...
ggsave("figures/rev2_nmds_all4.png", width = 9, height = 3, dpi = 400)
```
