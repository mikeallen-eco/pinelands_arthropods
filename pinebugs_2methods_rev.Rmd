...
# (Intercept)        3.4562     0.1096  31.535  < 2e-16 ***
# treeDeciduous      0.2204     0.1165   1.892   0.0635 .  
# methodUnderstory   0.6293     0.1216   5.174 2.99e-06 ***
# primerCOI         -0.8027     0.1163  -6.903 4.26e-09 ***
# Residual standard error: 0.4578 on 58 degrees of freedom
# Multiple R-squared:  0.571,	Adjusted R-squared:  0.5488 
# F-statistic: 25.73 on 3 and 58 DF,  p-value: 1.032e-10

# Evenness stats
# simpson_stats <- simpson_df20 %>%
...
summary(lm(simpson ~ tree + method + primer, data = simpson_df20))
#                  Estimate Std. Error t value Pr(>|t|)    
# (Intercept)       0.49111    0.06543   7.506 4.13e-10 ***
# treeDeciduous     0.08899    0.06952   1.280   0.2056    
# methodUnderstory  0.12953    0.07262   1.784   0.0797 .  
# primerCOI        -0.13784    0.06942  -1.986   0.0518 .  
# Residual standard error: 0.2733 on 58 degrees of freedom
# Multiple R-squared:  0.1288,	Adjusted R-squared:  0.08371 
# F-statistic: 2.858 on 3 and 58 DF,  p-value: 0.04473
...
summary(lm(shannon ~ tree + method + primer, data = shannon_df20))
#                  Estimate Std. Error t value Pr(>|t|)    
# (Intercept)        1.1353     0.1911   5.942  1.7e-07 ***
# treeDeciduous      0.2763     0.2030   1.361  0.17875    
# methodUnderstory   0.6503     0.2120   3.067  0.00328 ** 
# primerCOI         -0.3719     0.2027  -1.834  0.07173 .  
# Residual standard error: 0.7981 on 58 degrees of freedom
# Multiple R-squared:  0.1976,	Adjusted R-squared:  0.1561 
# F-statistic:  4.76 on 3 and 58 DF,  p-value: 0.004918

library(patchwork)

rareS.plot / rareSimpson.plot / rareShannon.plot

ggsave("figures/rev_Fig2_rarefieddiv_20k.png", width = 5, height = 7, dpi = 400)
```
