...
ggsave("figures/PlotK_body_size.jpg", 
...
loo_compare(fit.method.tree, fit.method, fit.tree, 
            criterion = "loo") %>% 
  print(simplify = F)
...
# model with both method and tree type
set.seed(102)
life.method.tree <- brm(bf(y | trials(size) ~ method + tree), 
...
# model with only method
set.seed(102)
life.method <- brm(bf(y | trials(size) ~ method), 
            data = dat, family = multinomial(refcat = "aqlar"),
            save_pars = save_pars(all = TRUE), 
                          iter = 4000, warmup = 2000,
                          chains = 4, cores = 4)
...
# model with only tree type
set.seed(102)
life.tree <- brm(bf(y | trials(size) ~ tree), 
            data = dat, family = multinomial(refcat = "aqlar"),
            save_pars = save_pars(all = TRUE), 
                          iter = 4000, warmup = 2000,
                          chains = 4, cores = 4)
...
# adding LOOIC criterion to 3 models
life.method.tree <- add_criterion(life.method.tree, "loo", 
                                 moment_match = T,
                          reloo = TRUE)
life.method <- add_criterion(life.method, "loo", 
                                 moment_match = T,
                          reloo = TRUE)
life.tree <- add_criterion(life.tree, "loo", 
                                 moment_match = T,
                          reloo = TRUE)
...
# load the models so we don't have to refit them each time
life.method.tree <- readRDS("output/feed_multinomial_method.tree.rds")
life.method <- readRDS("output/feed_multinomial_method.rds")
life.tree <- readRDS("output/feed_multinomial_tree.rds")

# evaluating models based on LOOIC
loo_compare(life.method.tree, life.method, life.tree, 
            criterion = "loo") %>% 
  print(simplify = F)
...
# model with both method and tree type
set.seed(102)
size.method.tree <- brm(bf(y | trials(size) ~ method + tree), 
...
# model with only method
set.seed(102)
size.method <- brm(bf(y | trials(size) ~ method), 
            data = dat, family = multinomial(refcat = "vsmal"),
            save_pars = save_pars(all = TRUE), 
                          iter = 4000, warmup = 2000,
                          chains = 3, cores = 3)
...
# model with only tree type
set.seed(102)
size.tree <- brm(bf(y | trials(size) ~ tree), 
            data = dat, family = multinomial(refcat = "vsmal"),
            save_pars = save_pars(all = TRUE), 
                          iter = 4000, warmup = 2000,
                          chains = 3, cores = 3)
...
# adding LOOIC criterion to 3 models
size.method.tree <- add_criterion(size.method.tree, "loo", 
                                 moment_match = T,
                          reloo = TRUE)
size.method <- add_criterion(size.method, "loo", 
                                 moment_match = T,
                          reloo = TRUE)
size.tree <- add_criterion(size.tree, "loo", 
                                 moment_match = T,
                          reloo = TRUE)
...
# load the models so we don't have to refit them each time
size.method.tree <- readRDS("output/feed_multinomial_method.tree.rds")
size.method <- readRDS("output/feed_multinomial_method.rds")
size.tree <- readRDS("output/feed_multinomial_tree.rds")

# evaluating models based on LOOIC
loo_compare(size.method.tree, size.method, size.tree, 
            criterion = "loo") %>% 
  print(simplify = F)
